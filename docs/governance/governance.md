...
- [TODS Specification](#transit-operational-data-standard-tods-specification)
...
How content of the [TODS Specification](#transit-operational-data-standard-tods-specification) may be changed and released as an official [TODS version](policies/change-management-versioning.md#tods-release).

### TODS Documentation

The text and website (and supporting scripts) which describe the [TODS Specification](#transit-operational-data-standard-tods-specification) and its purpose and usage located on the [TODS Repository](#tods-repository).

### TODS Repository

The version control repository containing the [TODS Specification](#transit-operational-data-standard-tods-specification) located at:
...
| [TODS Board Coordinator](#tods-board-coordinator) | Scott Frazier |
| [TODS Manager](#tods-manager) | [MobilityData](https://mobilitydata.org) |
| [TODS Program Manager](#tods-program-manager) | Scott Frazier |
| [TODS Contributors](#tods-contributor) | A member of the public who accepts and agrees to abide by the [TODS Code of Conduct](#tods-code-of-conduct) |
| [TODS Stakeholders](#tods-stakeholder) | Anyone who is interested in or could be directly affected by the TODS Project. |
...
- The Board MAY select an individual or organization to serve as the [TODS Manager](#tods-manager) to handle the day-to-day management of the [TODS Specification](#transit-operational-data-standard-tods-specification) and [TODS Project](#tods-project).
...
TODS Board [meetings](board-meetings.md) and [actions](actions.md) are published on this site.
...
- The [TODS Manager](#tods-manager) MUST communicate the name of the [TODS Program Manager](#tods-program-manager) to the [TODS Board](#ods-board-of-directors) in writing and notify the Board of any change in this assignment in writing.
- The [TODS Manager](#ods-manager) SHOULD select a new [TODS Program Manager](#tods-program-manager) if asked to do so by the TODS Board.
...
Anyone interested in or could be directly affected by the TODS Project. Interested parties may register for the [TODS distribution list](https://groups.google.com/g/ods-stakeholders).
